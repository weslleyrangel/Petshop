...
public class TelaAgendamentos extends javax.swing.JFrame {
    ...
    public TelaAgendamentos(UsuarioDAO usuarioDAO, PetController petController, TelaPrincipal telaPrincipal, AgendamentoController agendamentoController, UsuarioController usuarioController) throws ParseException {
        initComponents();
    ...
    public void exibirHorarioSelecionado(String horarioSelecionado) {
        txtHorarioSelecionado.setText(horarioSelecionado); 
    }
