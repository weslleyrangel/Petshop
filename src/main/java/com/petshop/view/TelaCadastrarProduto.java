...
import com.petshop.model.Produto; // Supondo que você tenha uma classe Produto
...
public class TelaCadastrarProduto extends javax.swing.JFrame {
    ...
    public TelaCadastrarProduto(UsuarioDAO usuarioDAO, PetController petController) {
        initComponents();
    ...
    private void btnCadastrarProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarProdutosActionPerformed
        ...
        // Converte os valores de preço e estoque
        BigDecimal preco = new BigDecimal(precoStr);
        int estoque = Integer.parseInt(estoqueStr);

        // Cria um novo objeto Produto
        Produto novoProduto = new Produto(null, nome, descricao, preco, estoque, categoria);
        // Salva o novo produto (você deve implementar o método no controlador)
        // produtoController.adicionarProduto(novoProduto); // Supondo que você tenha um método para adicionar produtos

        JOptionPane.showMessageDialog(this, "Produto cadastrado com sucesso!");
        btnLimparActionPerformed(evt); // Limpa os campos para iniciar um próximo cadastro
    ...
    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        ...
        cbCategoria.setSelectedIndex(0); // Reseta para o primeiro item
